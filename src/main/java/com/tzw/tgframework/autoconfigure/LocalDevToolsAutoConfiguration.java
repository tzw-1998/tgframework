...
import com.tzw.tgframework.restart.ConditionalOnInitializedRestarter;
...
public class LocalDevToolsAutoConfiguration {
	...
	@Lazy(false)
	@Configuration(proxyBeanMethods = false)
	@ConditionalOnProperty(prefix = "tgframework.restart", name = "enabled", matchIfMissing = true)
	static class RestartConfiguration {
		...
		@Bean
		@ConditionalOnProperty(prefix = "tgframework.restart", name = "log-condition-evaluation-delta",
				matchIfMissing = true)
