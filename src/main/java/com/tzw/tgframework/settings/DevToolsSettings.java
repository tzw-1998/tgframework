...
package com.tzw.tgframework.settings;

import com.tzw.tgframework.logger.DevToolsLogFactory;
...
/**
 * DevTools settings loaded from {@literal /META-INF/tgframework.properties} files.
 */
public class DevToolsSettings {
	 ...
	 */
	public static final String SETTINGS_RESOURCE_LOCATION = "META-INF/tgframework.properties";
