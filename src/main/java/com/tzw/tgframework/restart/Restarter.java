...
import com.tzw.tgframework.restart.FailureHandler.Outcome;
import com.tzw.tgframework.restart.classloader.ClassLoaderFiles;
import com.tzw.tgframework.restart.classloader.RestartClassLoader;
...
public class Restarter {
	...
	//如果applicationContext不是子进程 就准备一个ClassLoaderFilesResourcePatternResolver
	 ...
	 */
	//初始化方法 调用一系列方法 第一次初始化后再RestartApplicationListener中再次调用
	public static void initialize(String[] args, boolean forceReferenceCleanup, RestartInitializer initializer,
