...
package com.tzw.tgframework.env;

import com.tzw.tgframework.system.DevToolsEnablementDeducer;
...
public class DevToolsHomePropertiesPostProcessor implements EnvironmentPostProcessor {
	...
	private static final String[] FILE_NAMES = new String[] { "tgframework.yml", "tgframework.yaml",
			"tgframework.properties" };
